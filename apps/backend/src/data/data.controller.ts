...
function CommonApiQueries(): MethodDecorator {
  return applyDecorators(
    ...
    ApiQuery({
      name: 'bassinVersant',
      description:
        "Bassin versant, si non précisé, c'est tout le territoire français qui est pris en compte",
      required: false,
    }),
    ApiQuery({
      name: 'region',
      description:
        "Région, si non précisée, c'est tout le territoire français qui est pris en compte",
      required: false,
    }),
    ApiQuery({
      name: 'departement',
      description:
        "Département, si non précisé, c'est tout le territoire français qui est pris en compte",
      required: false,
    }),
  );
}
...
export class DataController {
  ...
  @ApiQuery({
    name: 'dateDebut',
    description:
      "Date de recherche (YYYY-MM), si non précisée c'est la date du jour qui est prise en compte",
    required: false,
  })
  @ApiQuery({
    name: 'dateFin',
