...
<template>
  <div class="fr-container">
    ...
    <div>
      ...
      <h2>Cookies</h2>
      <p>
        {{ appName }} dépose un petit fichier texte (un « cookie ») sur votre
      ...
      <p>
        Nous n'affichons pas de bannière de consentement aux cookies car nos
        outils de suivi d'audience sont correctement configurés pour respecter
        la vie privée des utilisateurs. Certains cookies sont dispensés du
        recueil préalable de votre consentement dans la mesure où ils sont
        strictement nécessaires à la fourniture du service. Les traceurs ont
        vocation à être conservés sur le poste informatique de l'internaute
      ...
      <p>
        ...
        via un outil libre intitulé
        <a href="https://matomo.org/" target="_blank" rel="external">Matomo</a>,
        ...
        enregistrée. Il est donc impossible d’associer les visites sur ce site
        à une personne.
      </p>
    </div>
  </div>
