...
import {
  ArreteMunicipalDto,
  arreteMunicipalPaginateConfig,
} from './dto/arrete_municipal.dto';
...
export class ArreteMunicipalController {
  constructor(
    private readonly arreteMunicipalService: ArreteMunicipalService,
  ) {}
  ...
  async findAll(
    ...
    const paginated = await this.arreteMunicipalService.findAll(
      query,
      req.session.user,
    );
  ...
  async create(
    ...
    createArreteMunicipalDto.communes = JSON.parse(
      createArreteMunicipalDto.communes,
    );
  ...
  async update(
    ...
    editArreteMunicipalDto.communes = JSON.parse(
      editArreteMunicipalDto.communes,
    );
